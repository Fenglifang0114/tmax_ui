...
extension MultiScaleManagementModbusExt on MultiScaleManagementState {
          ...
          children: [
            Expanded(
              child: textColorBtn(
                ...
                localizedStrings.gAddModbusService,
                btnHeight,
  ...
  Widget _buildModbusForm() {
    ...
    return Column(
      children: [
        subTitleInfo(context, MediaQuery.of(context).size.width - headWidthPadding,
        ...
        Expanded(
          child: ListView(
            children: [
              SizedBox(height: regularPadding),
              buildItemInfo(
                showItemNameWithStar(context, localizedStrings.gBindScaleId, true),
                showDropDownButton(
                  context,
                  "",
                  modbusIdCtl,
